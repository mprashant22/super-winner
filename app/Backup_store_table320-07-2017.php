...
<!--       		<option>-- Option3 --</option> -->
    	...
    	<td><a href='javascript: void(0)' class="delet-btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> <a data-handle="<?php echo($result['handle']); ?>" href='javascript: void(0)' class="remove-row delet-btn"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
	</tr>
	<?php $ii++;
 	}
	?>
