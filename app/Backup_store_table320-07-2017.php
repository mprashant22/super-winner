...
<div class="container" ng-app="">
  <div ng-controller="initApp">
    ...
    <table class="table table-striped table-bordered table-hover">
      <tbody>
        <tr>
          <th class="field0"><input type="checkbox" ng-model="selectedAll" ng-click="toggleSelect()" /> Select All <br/></th>
    ...
    <tr class="product_row" id="<?php echo $result['handle']; ?>">
		<td><ul><li ng-repeat="x in <?php echo print_r($result['handle'])?>"><input type="checkbox" ng-checked=.selectAll data-handle="<?php echo($result['handle']); ?>"></li></ul></td>
...
<!--       		<option>-- Option3 --</option> -->
    	...
    	<td><a href='javascript: void(0)'><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>~<a data-handle="<?php echo($result['handle']); ?>" href='javascript: void(0)'><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
	</tr>
	<?php $ii++;
 	}
	?>
