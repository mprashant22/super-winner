...
<!--       		<option>-- Option3 --</option> -->
    	...
    	<td><a href='javascript: void(0)'><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>~<a data-handle="<?php echo($result['handle']); ?>" href='javascript: void(0)' class="remove-row pull-right glyphicon glyphicon-trash"></a></td>
	</tr>
	<?php $ii++;
 	}
	?>
