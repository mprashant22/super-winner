...
$theme_id = '143487233';
	...
	function update_last_sync($last_sync, $api_key, $password, $store_url, $theme_id)
	{
		...
		if(isset($_POST['submit']))
		{
			echo "response";
			$text=$_POST['snippetText'];		
			$response = put_data('/admin/themes/'.$theme_id.'/assets.json?asset[key]=snippets/new_file2.liquid&theme_id='.$theme_id.'&asset[value]='.'NARENDRA', $data, $api_key, $password, $store_url, $theme_id);
